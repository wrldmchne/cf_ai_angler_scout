/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0432065598155ddbe78cdf96094821c2)
// Runtime types generated with workerd@1.20260205.0 2026-02-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FishingMemory";
	}
	interface Env {
		VECTOR_INDEX: VectorizeIndex;
		AI: Ai;
		ASSETS: Fetcher;
		FISHING_MEMORY: DurableObjectNamespace<import("./src/index").FishingMemory>;
		FISHING_WORKFLOW: Workflow<Parameters<import("./src/index").FishingWorkflow['run']>[0]['payload']>;
	}
}
